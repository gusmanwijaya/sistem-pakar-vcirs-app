...
const Dashboard = ({ data, users, history }) => {
  ...
  useEffect(() => {
    dispatch(fetchAllHamaPenyakit(true));
  }, [dispatch]);
    ...
    <Content title="Dashboard">
      <div className="alert shadow-lg">
        <div>
          ...
          <span>
            Sistem Pakar Menggunakan Metode Variable Centered Intellegent Rule
            System (VCIRS) Untuk Mengindentifikasi Hama Dan Penyakit Tanaman
            Kopi Robusta Berbasis Web
          </span>
        </div>
      </div>
            ...
            {users?.role === "admin" && (
              <>
                <Link href="/hama-penyakit">
                  <div className="cursor-pointer flex items-center p-4 bg-white rounded-lg shadow-xs">
