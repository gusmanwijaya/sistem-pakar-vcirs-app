          ...
          <div className="rounded-t mb-0 px-4 py-3 border-0">
            <div className="flex flex-row items-center">
              <button
                ...
                onClick={() => router.replace("/solusi/tambah")}
              >
                Tambah
              </button>
            </div>
            ...
            <table className="items-center w-full bg-transparent border-collapse">
              ...
              <tbody>
                {allData.map((value, index) => (
                  <tr key={index}>
                    <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs max-w-4xl p-4">
                      {value?.deskripsi}
                    </td>
                    <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs p-4 text-center space-x-1">
                      <button
                        className="btn btn-ghost btn-xs capitalize text-orange-500"
                        onClick={() =>
                          router.replace(`/solusi/ubah/${value?._id}`)
                        }
                      >
                        Ubah
                      </button>
